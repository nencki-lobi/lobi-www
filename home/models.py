...
class Profile(models.Model):
	...
	about = models.CharField("About (html allowed)",max_length=2000,blank=True)
	phone = models.CharField("Phone number",max_length=20,blank=True)
	research = models.CharField("Research interests (html allowed)",max_length=2000,blank=True)
	publications = models.CharField("Selected publications (html allowed)",max_length=12000,blank=True)
	funding = models.CharField("Funding (html allowed)",max_length=2000,blank=True)
...
class Research(models.Model):
	...
	about = models.CharField("More information (html allowed)",max_length=5000,blank=True)
	bold = models.BooleanField()
	image = models.ImageField("Graphic",upload_to="research",blank=True)
	about_image = models.CharField("Image caption",max_length=500,blank=True)
...
class Publication(models.Model):
	...
	about = models.CharField("More information (html allowed)",max_length=2000,blank=True)
	bold = models.BooleanField()
	image = models.ImageField("Graphic",upload_to="research",blank=True)
	link = models.CharField("External link (start with http://...)",max_length=500,blank=True)
...
class Course(models.Model):
	...
	about = models.CharField("More information (place etc., html allowed)",max_length=5000)
	bold = models.BooleanField()
	image = models.ImageField("Graphic",upload_to="research",blank=True)
	link = models.CharField("External link (start with http://...)",max_length=500,blank=True)
...
class News(models.Model):
	...
	title = models.CharField("Title",max_length=200)
	content = models.CharField("News content (html allowed)",max_length=2000)
